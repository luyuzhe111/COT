...
if __name__ == "__main__":
    ...
    base_model_alternate = torch.load(f"{save_dir_path}/base_model_alt.pt")
    base_model.eval()
    ...
    metrics, test_loss_ood, test_acc_ood = \
        baseline_evaluation(net=base_model,
                            testloader=val_ood_loader,
                            val_loader=val_iid_loader,
                            t=t,
                            t_vec=t_vec,
                            net2=base_model_alternate)
